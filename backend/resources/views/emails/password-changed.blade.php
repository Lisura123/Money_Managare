      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.07);">
        ...
        <tr>
          <td style="padding:32px 32px 24px 32px;color:#333333;font-size:14px;line-height:1.6;">
            ...
            <p style="margin:0 0 16px 0;">Your Money Manager account password has been changed by the administrator. Your new password is:</p>
              ...
              <tr>
                <td align="center">
                  <table role="presentation" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="background-color:#F0F0F0;border:1px solid #DDDDDD;border-radius:8px;padding:16px 32px;text-align:center;">
                        <span style="font-size:22px;font-weight:bold;color:#1B2A4A;font-family:'Courier New',Courier,monospace;letter-spacing:4px;">{{ $newPassword }}</span>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <p style="margin:0 0 16px 0;color:#E65100;font-size:13px;"><strong>For security, please change your password after your next login.</strong></p>

            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="background-color:#FFEBEE;border-left:4px solid #EF5350;padding:12px 16px;border-radius:4px;">
                  <p style="margin:0;font-size:13px;color:#555555;">If you did not expect this change, please contact your administrator immediately.</p>
                </td>
              </tr>
            </table>
          </td>
